...
import static me.jessyan.art.base.Platform.DEPENDENCY_ANDROID_EVENTBUS;
import static me.jessyan.art.base.Platform.DEPENDENCY_EVENTBUS;


/**
 * ================================================
 * EventBus 的管理类, Art 核心库并不会依赖某个 EventBus, 如果您想使用 EventBus, 则请在项目中自行依赖对应的 EventBus, 如果不想使用则不依赖
...
public final class EventBusManager {
    ...
    public void post(String event,String tag) {
        if (DEPENDENCY_ANDROID_EVENTBUS) {
