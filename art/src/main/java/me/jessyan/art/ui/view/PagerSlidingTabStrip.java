...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    protected int indicatorPadding = PixelUtil.dp2px(8);
    protected int underlineHeight = 2;
    protected int dividerPadding = 12;
    protected int tabPadding = 6;
...
//        float lineRight = lineLeft + textLength - ScreenUtil.dp2px(4) * 2;
        ...
        if (currentPositionOffset > 0f && currentPosition < tabCount - 1) {
            ...
            float nextTabLeft = (nextTab.getRight() - nextTab.getLeft() - textLength) / 2 + PixelUtil.dp2px(4) + nextTab.getLeft();
            float nextTabRight = nextTabLeft + textLength - PixelUtil.dp2px(4) * 2;
